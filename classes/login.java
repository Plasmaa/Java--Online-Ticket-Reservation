...
public class login extends log {
    ...
    JTextField tf1;
    JPasswordField pf1;
    JButton b1, b2, b3, b4, b5, b6, b7, b8,BackButton;
    JCheckBox c1;
    JComboBox religion;
    ImageIcon i1;
    JRadioButton r1, r2;
    ...
    login(String textField1, String textField2) {
		...
		l0 = new JLabel("ReserveEase");
        l0.setBounds(940, 70, 300, 80);
        l0.setForeground(Color.white);
        l0.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		BackButton.setBounds(4, 4, 100, 40);
        ...
        r1 = new JRadioButton("Seller Log In");
