...
public class Admin extends JFrame {
    ...
    Admin() {
        ...
        // Logo
        logo = new ImageIcon(getClass().getResource("/image/Admin.png"));
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Seller Panel");
        label1.setBounds(137, 420, 433, 50);
        label1.setFont(f1);
        c.add(label1);
        ...
        // btn4 = new JButton("Seller Password");
